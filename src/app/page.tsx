  ...
  return (
    <div className="bg-swish-bg min-w-screen min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="w-full absolute flex justify-center lg:pl-96 items-center top-0 lg:top-12 -z-10">
      ...
      <div className="pt-24 lg:flex lg:gap-72">
        <div className="lg:pl-32 lg:flex lg:flex-col lg:gap-14">
          <div className="lg:px-8 lg:py-8 lg:flex lg:items-center lg:w-[24rem] lg:h-72 lg:bg-gradient-to-t lg:rounded-xl  lg:from-dark-gray2 lg:to-light-gray2">
            <div>
              <div className="ml-16 lg:ml-0 flex items-center justify-center rounded-md lg:rounded-lg bg-gradient-to-t from-dark-gray to-light-gray w-10 h-10 lg:w-14 lg:h-14">
                <svg
                  className="h-8 lg:h-10 w-auto fill-current text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 -960 960 960"
                >
              ...
              <p className="pl-16 lg:pl-0 pt-4 lg:pt-6 text-3x lg:text-4xl font-bold text-white">
                Quick transfers
              </p>
              <p className="pl-16 lg:pl-0 lg:pt-8 lg:text-lg text-swish-light-text w-72 pt-2">
                Money in your bank account in just seconds.
              </p>
            </div>
          </div>
          <div className="hidden lg:px-8 lg:py-8 lg:flex lg:items-center lg:w-[24rem] lg:h-80 lg:bg-gradient-to-t lg:rounded-xl  lg:from-dark-gray2 lg:to-light-gray2">
            <div>
              <div className="ml-16 lg:ml-0 flex items-center justify-center rounded-md lg:rounded-lg bg-gradient-to-t from-dark-gray to-light-gray w-10 h-10 lg:w-14 lg:h-14">
                <svg
                  className="h-8 lg:h-10 w-auto fill-current text-white"
              ...
              <p className="pl-16 lg:pl-0 pt-4 lg:pt-6 text-3xl lg:text-4xl font-bold text-white">
                Request? <br></br> No problem.
              </p>
              <p className="pl-16 lg:pl-0 lg:pt-8 lg:text-lg text-swish-light-text w-60 pt-2">
