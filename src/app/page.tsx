  ...
  return (
    <div className="bg-swish-bg min-w-screen min-h-screen">
      ...
      <div className="pt-24 lg:flex lg:gap-72">
        <div className="lg:pl-32 lg:flex lg:flex-col lg:gap-20">
          <div className="lg:px-8 lg:py-8 lg:flex lg:items-center lg:w-[22rem] lg:h-56 lg:bg-gradient-to-t lg:rounded-xl  lg:from-dark-gray2 lg:to-light-gray2">
            <div>
              <div className="ml-16 lg:ml-0 flex items-center justify-center rounded-md bg-gradient-to-t from-dark-gray to-light-gray w-10 h-10">
                <svg
          ...
          <div className="hidden lg:px-8 lg:py-8 lg:flex lg:items-center lg:w-[22rem] lg:h-64 lg:bg-gradient-to-t lg:rounded-xl  lg:from-dark-gray2 lg:to-light-gray2">
            <div>
              <div className="ml-16 lg:ml-0 flex items-center justify-center rounded-md bg-gradient-to-t from-dark-gray to-light-gray w-10 h-10">
                <svg
                  className="h-8 w-auto fill-current text-white"
