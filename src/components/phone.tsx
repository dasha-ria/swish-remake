...
export function Phone({ children, className }: any) {
  ...
  return (
    <section className={className}>
      <div className="outside-border relative w-[250px] h-[500px] border-[0.6px] border-white -ml-[9px] mt-[37px] rounded-[35px]">
